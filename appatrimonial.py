...
period = st.sidebar.selectbox("Select time period", ["1y", "3y", "5y", "10y", "YTD"])
...
investment_amount = st.sidebar.number_input(
    ...
    min_value=0.0,
    max_value=10000000.0,  # Updated maximum value
    step=100.0,
    value=10000.0
)
allocation = {}
...
st.markdown("""
    ...
    **Investment Disclaimer:** Past performance is not indicative of future results. Investments involve risk, and potential investors should conduct their own due diligence before investing.  
    **Data Sources:** Data provided by Yahoo Finance and may not be real-time. Please verify all information before making investment decisions.
""")
